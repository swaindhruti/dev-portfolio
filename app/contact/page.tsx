    ...
    <main ref={containerRef} className="w-full min-h-screen flex flex-col justify-center px-6 sm:px-8 md:px-12 lg:px-24 bg-background text-foreground overflow-hidden">
      ...
      <div className="flex flex-col lg:flex-row lg:items-end justify-between mt-24 lg:mt-0">
        ...
        <div className="mb-16 lg:mb-4 lg:w-2/3">
          <h1 className="font-display text-[19vw] sm:text-[17vw] md:text-[15vw] lg:text-[16vw] leading-[0.9] uppercase flex items-end flex-wrap">
            <span className="flex overflow-hidden flex-wrap">
              {titleChars.map((char, index) => (
                char === " " ? (
                  <span key={index} className="inline-block w-[4vw] sm:w-[3.5vw] lg:w-[2vw]">&nbsp;</span>
                ) : (
        ...
        <div className="flex flex-col gap-10 lg:gap-10">
          ...
          <div className="contact-detail">
            ...
            <div>
              <a href="mailto:dhrutinandan.dev@gmail.com" className="font-faktum text-lg sm:text-xl md:text-2xl lg:text-3xl font-medium tracking-wide hover:opacity-60 transition-opacity">
